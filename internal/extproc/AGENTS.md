...
Do not import `internal/domain/`, `internal/ports/`, or `internal/adapters/` from `internal/extproc/`, except `internal/toolpattern` as authorized by ADR 035 for shared approval-pattern semantics.
